        ...
        <div class="bg-black p-6 rounded-lg shadow-lg">
            ...
            <div class="row">
                <div class="col flex justify-between">
                    <div class="flex space-x-4"> <!-- Controls the gap between the buttons within this group -->
                        <button
                    ...
                    <div class="flex space-x-4 ml-8">
                        <!-- Controls the gap between the buttons within this group and adds margin-left to create a gap -->
                        <button
            ...
            <div class="grid grid-cols-7 gap-2 text-center">
                ...
                <template x-for="day in ['16', '17', '18', '19', '20', '21', '22']">
                    <button @click="selectedDate = `2025-02-${day}`" class="p-4 rounded-md font-bold transition-all"
                        :class="selectedDate === `2025-02-${day}` ? 'bg-blue-600 text-white' :
            ...
            <div class="mt-6 flex space-x-6">
                ...
                <div class="flex-1">
                    <div class="mt-4 grid grid-cols-2 gap-6">
                        <template x-for="slot in slots[selectedDate]">
                            <div class="p-4 rounded-lg flex justify-between items-center shadow-md"
                ...
                <!-- Card -->
                <div class="p-6 rounded-lg shadow-lg mt-4" style="width: 67%; background: #222a4c">
                    <div class="row">
                        <div class="col">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 h-full">
                                <!-- Card 1 -->
                                <div class="max-w-sm rounded-lg shadow-lg bg-red-600 p-4" style="height: 95px">
                                    <div class="flex justify-between items-center">
                                        <div class="text-xl font-semibold text-gray-800">ROOM A</div>
                                        <div class="text-lg text-gray-600">KUPA</div>
                                        <div class="text-sm text-white">TIME LEFT: 2 Hrs 15 mins</div>
                                    </div>
                                </div>

                                <div class="max-w-sm rounded-lg shadow-lg bg-green-600 p-4" style="height: 95px">
                                    <div class="flex justify-between items-center">
                                        <div class="text-xl font-semibold text-gray-800">ROOM B</div>
                                        <div class="text-lg text-gray-600">COCHANKY</div>
                                ...
                                <div class="max-w-sm rounded-lg shadow-lg bg-green-600 p-4" style="height: 95px">
                                    <div class="flex justify-between items-center">
                                        <div class="text-xl font-semibold text-gray-800">ROOM C</div>
                                        <div class="text-lg text-gray-600">John Doe</div>
                                        <div class="text-sm text-white">AVAILABLE</div>
                                    </div>
                                </div>
                            </div>
